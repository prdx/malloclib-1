...
TESTS=t-test1 test1
HEADERS= mallutl.h malloc.h free.h calloc.h realloc.h reallocarray.h
...
libmalloc.so: malloc.o free.o mallutl.o calloc.o realloc.o reallocarray.o #add other sources here
